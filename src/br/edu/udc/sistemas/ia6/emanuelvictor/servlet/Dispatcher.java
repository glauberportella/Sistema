package br.edu.udc.sistemas.ia6.emanuelvictor.servlet;
...
import br.edu.udc.sistemas.ia6.emanuelvictor.controller.Controller;
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			if ((action != null) && (!action.equals(""))
				...
				Class<?> controllerClass = Class.forName("br.edu.udc.sistemas.ia6.emanuelvictor.controller.Controller"+ entityName);
